...
import "github.com/METADIV-GO/gorm/internal/constant"

/*
Eq creates a new clause with operator `=`.
*/
func Eq(field string, value any) *Clause {
	return newClause(field, constant.OP_EQ, value, false)
}
...
func DecryptEq(field string, value any) *Clause {
	return newClause(field, constant.OP_EQ, value, true)
}
...
func Neq(field string, value any) *Clause {
	return newClause(field, constant.OP_NEQ, value, false)
}
...
func DecryptNeq(field string, value any) *Clause {
	return newClause(field, constant.OP_NEQ, value, true)
}
...
func Gt(field string, value any) *Clause {
	return newClause(field, constant.OP_GT, value, false)
}
...
func Gte(field string, value any) *Clause {
	return newClause(field, constant.OP_GTE, value, false)
}
...
func Lt(field string, value any) *Clause {
	return newClause(field, constant.OP_LT, value, false)
}
...
func Lte(field string, value any) *Clause {
	return newClause(field, constant.OP_LTE, value, false)
}
...
func Like(field string, value any) *Clause {
	return newClause(field, constant.OP_LIKE, value, false)
}
...
func DecryptLike(field string, value any) *Clause {
	return newClause(field, constant.OP_LIKE, value, true)
}
...
func NotLike(field string, value any) *Clause {
	return newClause(field, constant.OP_NOT_LIKE, value, false)
}
...
func DecryptNotLike(field string, value any) *Clause {
	return newClause(field, constant.OP_NOT_LIKE, value, true)
}
...
func Similar(field string, value any) *Clause {
	return newClause(field, constant.OP_LIKE, "%"+value.(string)+"%", false)
}
...
func DecryptSimilar(field string, value any) *Clause {
	return newClause(field, constant.OP_LIKE, "%"+value.(string)+"%", true)
}
...
func NotSimilar(field string, value any) *Clause {
	return newClause(field, constant.OP_NOT_LIKE, "%"+value.(string)+"%", false)
}
...
func DecryptNotSimilar(field string, value any) *Clause {
	return newClause(field, constant.OP_NOT_LIKE, "%"+value.(string)+"%", true)
}
...
func In(field string, value ...any) *Clause {
	return newClause(field, constant.OP_IN, value, false)
}
...
func DecryptIn(field string, value ...any) *Clause {
	return newClause(field, constant.OP_IN, value, true)
}
...
func NotIn(field string, value ...any) *Clause {
	return newClause(field, constant.OP_NOT_IN, value, false)
}
...
func DecryptNotIn(field string, value ...any) *Clause {
	return newClause(field, constant.OP_NOT_IN, value, true)
}
...
func IsNull(field string) *Clause {
	return newClause(field, constant.OP_IS_NULL, nil, false)
}
...
func IsNotNull(field string) *Clause {
	return newClause(field, constant.OP_NOT_NULL, nil, false)
}
...
func And(children ...*Clause) *Clause {
	return newClause("", constant.OP_AND, nil, false, children...)
}
...
func Or(children ...*Clause) *Clause {
	return newClause("", constant.OP_OR, nil, false, children...)
}
